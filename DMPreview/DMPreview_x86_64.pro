...
INCLUDEPATH += $$PWD/../eSPDI/self_calibration/Self_Calibration_API/x86_64/include/


LIBS += -L$$PWD/../eSPDI -leSPDI_X86_64
LIBS += -L$$PWD/../eSPDI/self_calibration/Self_Calibration_API/x86_64/lib/ -lSelf_Calibration_API
