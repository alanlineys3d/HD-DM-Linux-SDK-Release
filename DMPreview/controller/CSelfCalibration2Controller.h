...
class CSelfCalibration2Controller : public QObject
{
    Q_OBJECT
public:
    class BinaryParser {
    ...
    CSelfCalibration2Controller(CVideoDeviceController *pVideoDeviceController, CVideoDeviceModel *pVideoDeviceModel);
    ...
    void StopSelfK2();
    void ResetSelfK2();
    bool WriteToFlash(float compensateCy);
